...
|-------------|---------|--------|
| Jellyfin | `jellyfin.example-media.net` | Protected by Zero Trust |
| Komga | `komga.example-media.net` | Protected by Zero Trust |
| API Gateway | `api.example-media.net` | Protected by Zero Trust |
